        ...
        <footer className="border-t py-12">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
                <div>
                    ...
                    <p className="text-gray-500 mb-4">Be the first to hear about new products, exclusive evets, and online offers</p>
                    <p className="font-medium text-sm text-gray-600 mb-6">Sign up and get 10% off your first order.</p>
                    <form className="flex">
                        <input type="email" placeholder="Enter your email" className="p-3 w-full text-sm border-t border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all" required />
                ...
                <div>
                    ...
                    <div className="flex items-center space-x-4 mb-4">
                        <a href="https://x.com/amandeep265" target="_blank" rel="noopener noreferrer" className="hover:text-gray-500">
